...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 47,
    name: "SALSA DE AJO PEQUEÑA",
    basePrice: 13000,
    price: 13000,
    body: "Cremosa, intensa y perfectamente balanceada, nuestra receta familiar de Salsa de Ajo. Es el secreto que se queda en tu memoria. (320ml)",
    bigImage: "/images/products/garlic-sauce-large.webp",
    image1: "/images/products/sauce-thumbnail.webp",
    icons: [HuevoIcon, AjoIcon],
    quantity: 1,
